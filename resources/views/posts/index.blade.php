        ...
        <div class="row justify-content-center">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                        <div class="modal-content">
                                            <ul class="list-group">
                                                ...
                                                @can('delete', $post)
                                                    <form action="{{ url()->action('PostsController@destroy', $post->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method("DELETE")
                                            ...
                                            <div class="modal-content">
                                                <ul class="list-group">
                                                    <li class="list-group-item"
                                                        ...
                                                        <input type="text" value="http://localhost:8000/p/{{ $post->id }}"
                                                            id="copy_{{ $post->id }}" />
                                                    </li>
                                                    <li class="btn list-group-item" data-dismiss="modal"
                                                        onclick="copyToClipboard('copy_{{ $post->id }}')">Copy Link</li>
                                                    <li class="btn list-group-item" data-dismiss="modal">Cancel</li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <aside class="aside col-md-4 py-3">
                <div class="position-fixed">
                    ...
                    <!-- CopyRight -->
                    <div>
                        <span style='color: #a6b3be;'>© 2021 InstaClone from Ynov warriors</span>
                    </div>
...
{{-- <script>
    ...
    " action=" {
        {
            url() - > action('PostsController@updatelikes', ['post' => $post - > id])
        }
    }
    ">
